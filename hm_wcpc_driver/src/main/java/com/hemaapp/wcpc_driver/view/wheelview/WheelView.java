...
import com.hemaapp.wcpc_driver.view.wheelview.adapter.WheelViewAdapter;
 ...
 */
@SuppressLint("ClickableViewAccessibility") public class WheelView extends View {
...
//		centerDrawable.draw(canvas);
        Paint paint = new Paint();//使用自己的画线，而不是描边
        paint.setColor(getResources().getColor(R.color.xian));
        // 设置线宽

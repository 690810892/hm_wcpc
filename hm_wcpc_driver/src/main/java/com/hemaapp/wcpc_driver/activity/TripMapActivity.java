 ...
 */
public class TripMapActivity extends BaseActivity implements
...
//            aMap.clear();// 清理地图上的所有覆盖物
    ...
    protected void getExras() {
        start_lat = mIntent.getStringExtra("lat_start");
        start_lng = mIntent.getStringExtra("lng_start");
        end_lat = mIntent.getStringExtra("lat_end");
        end_lng = mIntent.getStringExtra("lng_end");
    ...
    private class ImageTask extends XtomImageTask {
        ...
        TripMapActivity context;

        private ImageTask(ImageView imageView, URL url, TripMapActivity context) {

...
public class RecycleUtils {
    ...
    public static void initHorizontalRecyle(RecyclerView recyclerView){
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(hm_WcpcDriverApplication.getInstance());
        layoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
        recyclerView.setLayoutManager(layoutManager);
    }
    public static void initHorizontalRecyleNoScrll(RecyclerView recyclerView){

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(hm_WcpcDriverApplication.getInstance()) {
            @Override

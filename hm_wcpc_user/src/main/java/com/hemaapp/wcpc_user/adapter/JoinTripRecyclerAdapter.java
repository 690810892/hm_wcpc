...
import com.hemaapp.wcpc_user.activity.JoinTripsActivity;
 ...
 */
public class JoinTripRecyclerAdapter extends
        RecyclerView.Adapter<JoinTripRecyclerAdapter.MyViewHolder> {

    private ArrayList<PersonCountInfor> types;
    private JoinTripsActivity mContext;

    public JoinTripRecyclerAdapter(JoinTripsActivity mContext,

...
import com.hemaapp.wcpc_user.activity.SelectCity2Activity;
import com.hemaapp.wcpc_user.activity.SelectCityActivity;
...
/**
 */
public class Location2Adapter extends HemaAdapter {

    private SelectCity2Activity mActivity;
    private List<DistrictInfor> list;
    private HashMap<String, Integer> alphaIndexer;

    public Location2Adapter(Context mContext) {
        super(mContext);
        mActivity = (SelectCity2Activity) mContext;
    }

...
import com.hemaapp.wcpc_user.adapter.MyTripsListAdapter;
...
public class MyTripsListActivity extends BaseActivity {
    ...
    private void getTripList(int page){
        getNetWorker().myTripsList(user.getToken(), keytype, "1", page);
    }
    ...
    private class ButtonListener implements HemaButtonDialog.OnButtonListener {
        ...
        public void onRightButtonClick(HemaButtonDialog dialog) {
            ...
            if(type == 0){
                ...
                getNetWorker().myTripsOperate(user.getToken(), "1", "1", order_id);
            }else if(type == 1){

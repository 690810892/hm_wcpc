...
import com.hemaapp.wcpc_user.adapter.Location2Adapter;
...
public class SelectCity2Activity extends BaseActivity {
    ...
    private Location2Adapter mLocationAdapter;
...
//        getNetWorker().districtList("-1");
    ...
    protected void findView() {
        ...
        mLocationAdapter = new Location2Adapter(this);
    }
    ...
    public void onItemClick(DistrictInfor infor){
        Intent it=new Intent(mContext,FeeRuleListActivity.class);
        it.putExtra("city", infor.getName());
        it.putExtra("city_id", infor.getCity_id());
        startActivity(it);
    }
